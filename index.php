...
<body>
	...
	<!-- banner -->
	<section id="banner" class="pt-5 pb-3 py-md-5">
		<div class="container pt-5">
			<div class="row">
				<div class="col-md-6 d-flex align-self-center">
					<article class="banner-text">
						<h1 class="h3">Laundry Online di RUMAH LAUNDRY 381!</h1>
						<p class="moto">Bersama Rumah Laundry 381, Pesan Laundry #DirumahAja</p>
						<a href="order.php" class="btn btn-warning btn-order text-white">Pesan Sekarang!</a>
					</article>
				</div>
	...
	<section id="features" class="pt-3">
		<div class="container mt-4 text-center">
			<h2 class="mb-5 font-weight-bold h3">Layanan Rumah Laundry 381</h2>
			<div class="row">
				<div class="col-md-3">
	...
	<!-- batas -->
	<!-- prioritas -->
	<section id="contact" class="pt-3 mb-5 mb-md-0">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
				...
				<div class="col-md-6 mt-md-5 d-flex align-self-center">
					<article>
						<h3 class="font-weight-bold mt-3">Rumah Laundry 381 Jadikan Kamu Sebagai Prioritas!</h3>
